...
RSpec.describe MessagesController, type: :controller do
  ...
  describe '#create' do
    ...
    it 'creates a message with the current user in the selected channel' do
      ...
      expect {
        post :create, { channel_id: channel_one.id, message: { content: 'hello' }, format: :json }
      ...
      expect(current_user.channels.first.messages.first.channel_id).to eq channel_one.id
    end
  end
end
